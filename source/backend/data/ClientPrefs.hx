...
class ClientPrefs {
	...
	public static function saveSettings() {
		...
		settings.data.hitboxPT = hitboxPT;
		settings.data.hitboxLocation = hitboxLocation;
		settings.data.hitboxmode = hitboxmode;
		settings.data.hitboxalpha = hitboxalpha;
		settings.data.virtualPadAlpha = virtualPadAlpha;
	...
	public static function loadPrefs() {
		...
		if(settings.data.hitboxLocation != null) {
			hitboxLocation = settings.data.hitboxLocation;
		}
		if(settings.data.hitboxPT != null) {
			hitboxPT = settings.data.hitboxPT;
		}
		if(settings.data.hitboxmode != null) {
			hitboxmode = settings.data.hitboxmode;
		}
		if(settings.data.hitboxalpha != null) {
			hitboxalpha = settings.data.hitboxalpha;
		}
		if(settings.data.virtualPadAlpha != null) {
			virtualPadAlpha = settings.data.virtualPadAlpha;
		}
