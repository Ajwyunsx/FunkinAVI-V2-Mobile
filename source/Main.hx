...
class Main extends Sprite
{
	...
	private function setupGame():Void
	{
		...
		var game:FlxGame = new FlxGame(gameWidth, gameHeight, android.CopyState, #if (flixel < "5.0.0") zoom, #end framerate, framerate, skipSplash, startFullscreen);
